...
unsigned int nTargetSpacing = 1 * 150; // 150 seconds
...
const string strMessageMagic = "BeatsCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 <= 100000)
    {
      nSubsidy = 50 * COIN;
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    if ( (pindexBest->nHeight+1 >= 100000 && pindexBest->nHeight+1 < 200000) || pindexBest->nHeight+1 > 500000 )
    {
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BeatsCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sun, 14 Aug 2016 18:09:13 GMT";
        CTransaction txNew;
        txNew.nTime = 1471198153;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x24fa18f40b780ad8d60d96c8e9758b348a9c7918ef43d18ac908c831a7da9ae5"));
        block.print();
